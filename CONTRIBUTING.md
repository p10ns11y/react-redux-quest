...
For **support or usage questions** like "How do I do X with apie." and "My code doesn't work.", please search and ask on **StackOverflow** with a **'apie' tag** first.
...
**Before filing an issue please [search the issue tracker](https://github.com/p10ns11y/apie/issues); your issue may have already been discussed or fixed in `master`.**
...
[issue tracker](https://github.com/p10ns11y/apie/issues), with a **description** (follow the template) of the expected behavior & use case, where they’ll remain until **approval** by the **lead maintainer(s) and/or enough interest** from the **community**.

You can **request** a feature by **writing a pull request**, but this is **no guarantee** it will be **merged**.

## 'help wanted' label

There are issues marked with the **['help wanted'](https://github.com/p10ns11y/apie/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22)** label. <br/>This is a perfect start if you want to help out with the further development of apie.
...
1. **Fork** the repo.
2. **Clone** the repo. `git clone https://github.com/your-username/apie.git`.
